...
// Creado: 7/2/2014
//
// Función: Implementa un componente Memo para obtener la
...
//Teclas de letras del alfabeto y número superiores.
const TvkGeneral = TvkAlfaNumerico + TvkNumericoExtendido + TvkOtras;
...
//-----------------------------------------------------------------------------
constructor TKdMemo.Create(AOwner : TComponent);
begin
...
//-----------------------------------------------------------------------------
procedure TKdMemo.TimingVectorAdd(Evento: Char; Tecla: Byte; MarcaDeTiempo: Cardinal);
begin
...
//-----------------------------------------------------------------------------
function TKdMemo.TimingVectorExist: Boolean;
begin
...
//-----------------------------------------------------------------------------
function TKdMemo.GetTimingVectorLength: Integer;
begin
...
//-----------------------------------------------------------------------------
procedure TKdMemo.TimingVectorToFileCSV(Name: String);
var CSV: TextFile;
    Linea: String;
    n: Integer;
begin
...
//-----------------------------------------------------------------------------
function TKdMemo.TeclaValida(var Message: TWMKeyDown): Boolean;
begin
Result := False;
...
//-----------------------------------------------------------------------------
procedure TKdMemo.WMKeyDown(var Message: TWMKeyDown);
...
//-----------------------------------------------------------------------------
procedure TKdMemo.WMKeyUp(var Message: TWMKeyUp);
var MarcaDeTiempo: Cardinal;
begin
//Guarda la marca de tiempo del evento.
MarcaDeTiempo := GetTickCount;
...
procedure Register;
begin
RegisterComponents('Keystroke Dynamic', [TKdMemo]);
end;
